    ...
    return (
        <div className='my-8 w-full max-w-sm mx-auto'>
            ...
            <div className='flex items-center justify-between my-2'>
                <div className='flex items-center gap-3'>
                    {
                        liked ? <FaThumbsUp onClick={likeOrDislikeHandler} size={'24'} className='cursor-pointer text-blue-700' style={{color: '#0077B5'}} /> : <FaRegThumbsUp onClick={likeOrDislikeHandler} size={'22px'} className='cursor-pointer hover:text-gray-600' />
                    }
